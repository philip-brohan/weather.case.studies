...
plot.hour<-function(year,month,day,hour) {
    ...
    image.name<-sprintf("V3vV2c.mfm.%04d-%02d-%02d:%02d.%02d.pdf",year,month,day,as.integer(hour),
...
plot.hour.V3<-function(year,month,day,hour,streamlines) {
    ...
    t2m<-get.mean.at.hour('air.2m',year,month,day,hour,version='4.1.8')
    ...
    icec<-get.mean.at.hour('icec',year,month,day,hour,version='4.1.8')
    prate<-get.mean.at.hour('prate',year,month,day,hour,version='4.1.8')
