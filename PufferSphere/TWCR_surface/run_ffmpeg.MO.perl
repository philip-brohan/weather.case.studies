...
my $Count = 0;
my $Glob  = "/scratch/hadpb/images/TWCR_spherical_obliquity/*.png";
...
`ffmpeg -r 36 -i $Tdir/%04d.png -vcodec libx264 -vpre slow /scratch/hadpb/images/TWCR_new_colours3.mov`;
