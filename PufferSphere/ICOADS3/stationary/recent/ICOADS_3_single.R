...
# Slower and fewer obs shown at once - better for recent years
...
Imagedir<-sprintf("%s/images/ICOADS3.stationary.hourly",Sys.getenv('SCRATCH'))
...
plot.hour<-function(year,month,day,hour) {    
    ...
    obs.ic<-ICOADS.3.0.get.obs(year,month,day,hour,12)
