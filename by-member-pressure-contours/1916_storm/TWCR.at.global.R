...
Day<-2
Hour<-0
n.total<-24*364 # Total number of timesteps to be rendered
version<-'3.5.1'
fog.threshold<-exp(1)
...
Imagedir<-sprintf("%s/images/1916-global-at",Sys.getenv('SCRATCH'),version)
...
Options$mslp.range=30                    # Anomaly for max contour
Options$mslp.step=3                       # Smaller -more contours
Options$mslp.tpscale=10                    # Smaller -contours less transparent
